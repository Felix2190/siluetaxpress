<?php
	...
	class ModeloBasePromociones_ruleta extends clsBasicCommon
	{
		...
		var $__s=array("idPromocionRuleta","idFranquicia","idSucursal","nombrePromocion","idUsuarioModifico","fechaModificacion");
		var $__ss=array();
		...
		protected function Insertar()
		{
			try
			{
				$SQL="INSERT INTO promociones_ruleta(idFranquicia,idSucursal,nombrePromocion,idUsuarioModifico,fechaModificacion)
						VALUES('" . mysqli_real_escape_string($this->dbLink,$this->idFranquicia) . "','" . mysqli_real_escape_string($this->dbLink,$this->idSucursal) . "','" . mysqli_real_escape_string($this->dbLink,$this->nombrePromocion) . "','" . mysqli_real_escape_string($this->dbLink,$this->idUsuarioModifico) . "','" . mysqli_real_escape_string($this->dbLink,$this->fechaModificacion) . "')";
		...
		public function getDatos()
		{
			...
			{
				$SQL="SELECT
						idPromocionRuleta,idFranquicia,idSucursal,nombrePromocion,idUsuarioModifico,fechaModificacion
