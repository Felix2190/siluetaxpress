...
Tags: form, forms, form builder, booking forms, bootstrap forms, contact forms, cost calculator form, cost form, estimation form,  form creator, mailchimp form, multistep form, paypal form
...
Popup Forms, Interactive Forms, Multi-Step Forms, Sticky Forms, Contact Forms, Payment Forms, Booking Forms, Quiz Forms and more.

== Description ==

### All new version 7!
Includes 100+ new features and overall usability enhancements and google material design integration!!

### Demo **[See live Demo](http://basixonline.net/nex-forms-wordpress-form-builder-demo/ "The Ultimate WordPress Form Builder")**

###  **[Documentation](http://basixonline.net/nex-forms-docs "NEX-Forms Documentation")**
...
1. NEX Forms WordPress Form Builder - back-end
2. NEX Forms WordPress Form Builder - form-menu
3. NEX Forms WordPress Form Builder - edit-menu
4. NEX Forms WordPress Form Builder - view-menu
5. NEX Forms WordPress Form Builder - help-menu
6. NEX Forms WordPress Form Builder - full-screen-view
7. NEX Forms WordPress Form Builder - conditional-logic
8. NEX Forms WordPress Form Builder - multi-step
9. NEX Forms WordPress Form Builder - interactive-tutorial
10. NEX Forms WordPress Form Builder - documentation
11. NEX Forms WordPress Form Builder - live-form-preview
12. NEX Forms WordPress Form Builder - email-setup
13. NEX Forms WordPress Form Builder - submission-options
14. NEX Forms WordPress Form Builder - hidden-fields
15. NEX Forms WordPress Form Builder - email-configuration
16. NEX Forms WordPress Form Builder - preferences
17. NEX Forms WordPress Form Builder - preferences
18. NEX Forms WordPress Form Builder - styling-tools
19. NEX Forms WordPress Form Builder - form-themes
20. NEX Forms WordPress Form Builder - paypal
21. NEX Forms WordPress Form Builder - custom-admin-layout-1
22. NEX Forms WordPress Form Builder - custom-admin-layout-2
23. NEX Forms WordPress Form Builder - custom-admin-layout-3
24. NEX Forms WordPress Form Builder - form-entries
25. NEX Forms WordPress Form Builder - form-entries
...
Yes, go to http://basixonline.net/nex-forms/nex-forms-documentation/ or view the interactive tutorial to help you on your way to create forms
