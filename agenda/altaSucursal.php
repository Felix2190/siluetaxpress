...
<html>
	<head>
		<title>A&ntilde;adir sucursal</title>
		<meta charset="utf-8" />
				...
				<!-- Main -->
					<div id="main">
						<div class="inner" id="divArriba">
							...
							<!-- Section -->
								<section>
									<h2 id="content"><img src="images/agregar.png" style="width: 60px;" />&ensp;Nueva sucursal</h2>
						...
						<div class="row">
							...
							<div class="4u 12u$(xsmall)">
								<textarea rows="2" cols="" id="txtDireccion"></textarea>
							</div>
						</div>
						<br />
						<div class="row">
