<?php
	...
	class ModeloBaseHojaclinica extends clsBasicCommon
	{
		...
		var $__s=array("idHojaClinica","fechaRegistro","cirugia","cirugias","enfermedades","estrenimiento","estrenimientoFrecuencia","menstruacion","alergia","alimento","hrsDormir","hrsComer","cafe","cafeFrecuencia","fuma","fumaFrecuencia","beber","beberFrecuencia","desagradables","ansiedad","actividadFisica","actividad","tiempo","tiempoSimbolo","actividadFisicaFrecuencia","motivacion","horarioLevantarse","horarioAcostarse","horarioActividad","desayuno","horarioDesayuno","actividadDesayuno","colacion","horarioColacion","actividadColacion","comida","horarioComida","actividadComida","colacion2","horarioColacion2","actividadColacion2","cena","horarioCena","actividadCena","peso_habitual","peso_ideal","antecedentes","tratamientos","observaciones","completitud");
		var $__ss=array();
