<?php
	...
	class ModeloBaseHojaclinica extends clsBasicCommon
	{
		...
		var $__s=array("idHojaClinica","fechaRegistro","cirugia","cirugias","enfermedades","estrenimiento","estrenimientoFrecuencia","menstruacion","alergia","alimento","hrsDormir","hrsComer","cafe","cafeFrecuencia","fuma","fumaFrecuencia","beber","beberFrecuencia","desagradables","ansiedad","actividadFisica","actividad","tiempo","tiempoSimbolo","actividadFisicaFrecuencia","motivacion","horarioLevantarse","horarioAcostarse","horarioActividad","desayuno","horarioDesayuno","actividadDesayuno","colacion","horarioColacion","actividadColacion","comida","horarioComida","actividadComida","colacion2","horarioColacion2","actividadColacion2","cena","horarioCena","actividadCena","peso_habitual","peso_ideal","estatura","antecedentes","tratamientos","observaciones","completitud");
		var $__ss=array();
		...
		public function setPeso_habitual($peso_habitual)
		{
			$this->peso_habitual=$peso_habitual;
		}
		public function setPeso_ideal($peso_ideal)
		{
		...
		public function getPeso_habitual()
		{
			return $this->peso_habitual;
		}
		public function getPeso_ideal()
		{
