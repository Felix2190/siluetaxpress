<?php
	...
	class ModeloBaseSucursal extends clsBasicCommon
	{
		...
		var $idFranquicia=0;
		var $enviarSMS='No';
		var $enviarWhatsapp='0';
		var $enviarRecordatorio='No';

		var $__s=array("idSucursal","sucursal","cveEstado","cveMunicipio","direccion","estatus","entreSemanaEntrada","entreSemanaSalida","sabadoEntrada","sabadoSalida","numTelefono","idFranquicia","enviarSMS","enviarWhatsapp","enviarRecordatorio");
		var $__ss=array();
		...
		public function setEnviarWhatsapp()
		{
			$this->enviarWhatsapp=1;
		}
		...
		public function unsetEnviarWhatsapp()
		{
			$this->enviarWhatsapp=0;
		}
		...
		public function getEnviarWhatsapp()
		{
		...
		protected function Insertar()
		{
			try
			{
				$SQL="INSERT INTO sucursal(sucursal,cveEstado,cveMunicipio,direccion,estatus,entreSemanaEntrada,entreSemanaSalida,sabadoEntrada,sabadoSalida,numTelefono,idFranquicia,enviarSMS,enviarWhatsapp,enviarRecordatorio)
						VALUES('" . mysqli_real_escape_string($this->dbLink,$this->sucursal) . "','" . mysqli_real_escape_string($this->dbLink,$this->cveEstado) . "','" . mysqli_real_escape_string($this->dbLink,$this->cveMunicipio) . "','" . mysqli_real_escape_string($this->dbLink,$this->direccion) . "','" . mysqli_real_escape_string($this->dbLink,$this->estatus) . "','" . mysqli_real_escape_string($this->dbLink,$this->entreSemanaEntrada) . "','" . mysqli_real_escape_string($this->dbLink,$this->entreSemanaSalida) . "','" . mysqli_real_escape_string($this->dbLink,$this->sabadoEntrada) . "','" . mysqli_real_escape_string($this->dbLink,$this->sabadoSalida) . "','" . mysqli_real_escape_string($this->dbLink,$this->numTelefono) . "','" . mysqli_real_escape_string($this->dbLink,$this->idFranquicia) . "','" . mysqli_real_escape_string($this->dbLink,$this->enviarSMS) . "','" . mysqli_real_escape_string($this->dbLink,$this->enviarWhatsapp) . "','" . mysqli_real_escape_string($this->dbLink,$this->enviarRecordatorio) . "')";
		...
		public function getDatos()
		{
			...
			{
				$SQL="SELECT
						idSucursal,sucursal,cveEstado,cveMunicipio,direccion,estatus,entreSemanaEntrada,entreSemanaSalida,sabadoEntrada,sabadoSalida,numTelefono,idFranquicia,enviarSMS,enviarWhatsapp,enviarRecordatorio
					FROM sucursal
					WHERE idSucursal=" . mysqli_real_escape_string($this->dbLink,$this->idSucursal);
